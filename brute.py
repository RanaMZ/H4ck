...
if __name__ == '__main__':
	...
	try:
		...
		if pil == '1':
			...
			try:
				subprocess.check_output(['am', 'start', 'https://youtu.be/IxSsxgdeTVA'])
			except KeyboardInterrupt:
				subprocess.check_output(['am', 'start', 'https://youtu.be/IxSsxgdeTVA'])
			except WindowsError:
			...
			try:
				...
				print " \n\033[95;1m   Silahkan Ikuti Instagram saya \033[96;1m(Rana MZ)"
				raw_input(" \033[97;1m    Tekan Enter Untuk Membuka Instagram..")
				subprocess.check_output(['am', 'start', 'https://www.instagram.com/ranamz.zeshi/'])
				os.system('brute.py' if os.name == 'nt' else 'python2 brute.py')
			except KeyboardInterrupt:
				subprocess.check_output(['am', 'start', 'https://www.instagram.com/https://www.instagram.com/ranamz.zeshi/'])
				os.system('brute.py' if os.name == 'nt' else 'python2 brute.py')
			except WindowsError:
				os.system('brute.py' if os.name == 'nt' else 'python2 brute.py')
